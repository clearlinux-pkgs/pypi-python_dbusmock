...
Source0  : https://files.pythonhosted.org/packages/d2/b1/240ad35502c356f9f6e30ca246b66df6ff44b01a115920da27bf7a8d4ea7/python-dbusmock-0.32.2.tar.gz
...
%prep
%setup -q -n python-dbusmock-0.32.2
cd %{_builddir}/python-dbusmock-0.32.2
%patch -P 1 -p1
pushd ..
cp -a python-dbusmock-0.32.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727966380
