...
Version  : 0.31.1
Release  : 43
URL      : https://files.pythonhosted.org/packages/bb/6f/9f958b3e9d3165b552e00c10f1c047fd2e235f6e58021be5225279f7b88b/python-dbusmock-0.31.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/bb/6f/9f958b3e9d3165b552e00c10f1c047fd2e235f6e58021be5225279f7b88b/python-dbusmock-0.31.1.tar.gz
...
%prep
%setup -q -n python-dbusmock-0.31.1
cd %{_builddir}/python-dbusmock-0.31.1
%patch -P 1 -p1
pushd ..
cp -a python-dbusmock-0.31.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708705196
