...
Version  : 0.27.3
Release  : 15
URL      : https://files.pythonhosted.org/packages/f5/cb/1eaff91dc0797de8a71a5e0f21dba3293618c309fe2e2218be86b674ef4c/python-dbusmock-0.27.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/f5/cb/1eaff91dc0797de8a71a5e0f21dba3293618c309fe2e2218be86b674ef4c/python-dbusmock-0.27.3.tar.gz
...
%prep
%setup -q -n python-dbusmock-0.27.3
cd %{_builddir}/python-dbusmock-0.27.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647987279
...
cp %{_builddir}/python-dbusmock-0.27.3/COPYING %{buildroot}/usr/share/package-licenses/pypi-python_dbusmock/f45ee1c765646813b442ca58de72e20a64a7ddba
