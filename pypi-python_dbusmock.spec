...
Version  : 0.32.1
Release  : 44
URL      : https://files.pythonhosted.org/packages/15/fc/e8b8e1e887a011685b71e9d61dcfbf05cdbd720878922e80ed5000798788/python-dbusmock-0.32.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/15/fc/e8b8e1e887a011685b71e9d61dcfbf05cdbd720878922e80ed5000798788/python-dbusmock-0.32.1.tar.gz
...
%prep
%setup -q -n python-dbusmock-0.32.1
cd %{_builddir}/python-dbusmock-0.32.1
%patch -P 1 -p1
pushd ..
cp -a python-dbusmock-0.32.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721062618
