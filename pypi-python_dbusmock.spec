...
Version  : 0.35.0
Release  : 51
URL      : https://files.pythonhosted.org/packages/30/31/ee9fac5ad7c33f36420d1bda7d1502ed56f7885dddf87726618c30c48073/python_dbusmock-0.35.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/30/31/ee9fac5ad7c33f36420d1bda7d1502ed56f7885dddf87726618c30c48073/python_dbusmock-0.35.0.tar.gz
...
%prep
%setup -q -n python_dbusmock-0.35.0
cd %{_builddir}/python_dbusmock-0.35.0
%patch -P 1 -p1
pushd ..
cp -a python_dbusmock-0.35.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748009358
