...
Version  : 0.34.3
Release  : 50
URL      : https://files.pythonhosted.org/packages/54/02/ec6c7982d80c5c9e6d1beb445ca0a928bc945670e50b8b5a9cd1075b4f84/python_dbusmock-0.34.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/54/02/ec6c7982d80c5c9e6d1beb445ca0a928bc945670e50b8b5a9cd1075b4f84/python_dbusmock-0.34.3.tar.gz
...
%prep
%setup -q -n python_dbusmock-0.34.3
cd %{_builddir}/python_dbusmock-0.34.3
%patch -P 1 -p1
pushd ..
cp -a python_dbusmock-0.34.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740151414
