...
Provides: python-dbusmock-python
Provides: python-dbusmock-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641482972
...
cp %{_builddir}/python-dbusmock-0.25.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-python_dbusmock/f45ee1c765646813b442ca58de72e20a64a7ddba
