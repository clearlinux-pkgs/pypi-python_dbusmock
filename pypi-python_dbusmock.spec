...
%prep
%setup -q -n python-dbusmock-0.28.0
cd %{_builddir}/python-dbusmock-0.28.0
pushd ..
cp -a python-dbusmock-0.28.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656401684
...
cp %{_builddir}/python-dbusmock-0.28.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-python_dbusmock/f45ee1c765646813b442ca58de72e20a64a7ddba
